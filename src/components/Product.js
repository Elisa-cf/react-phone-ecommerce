          ...
          <ProductConsumer>
            {value => (<div className="img-container p-5" onClick={() => {value.handleDetail(id)}}>
              ...
              <button className="cart-btn" disabled={inCart ? true : false} onClick={() => { 
                ...
                {inCart ? (<p className="text-capitalize mb-0" disabled>In cart</p>) : (<i className='fas fa-cart-plus' />)}</button>
            </div>)}
...
// transition:all 1s linear => property - how long - type of the transition-